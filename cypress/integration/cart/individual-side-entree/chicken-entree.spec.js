...
beforeEach('Visit cart', () => {
    ...
    cy.wait(1000)
    cy.clickChickenEntree()
    cy.wait(1000)
    cy.selectChickenEntreeSize('BBQ Chicken', "Regular")
    cy.clickEntreePlus('BBQ Chicken')
    cy.clickEntreeAddToCart('BBQ Chicken')
    cy.wait(1000)
})

describe('Visit cart, add regular size of BBQ Chicken, and check in the cart', () => {
    it('Click chicken entree, click plus button for regular size of bbq chicken, then check all information on the screen', () => {
        cy.get('#cart_count').contains('1')

        const sql = 'select * from products where name = "Regular Chicken"'
        cy.task('queryDb', sql)
            .then((result) => {
                // Image
                const sqlEntrees = 'select * from entrees where name = "BBQ Chicken"'
    ...
    it('Click chicken entree, click plus button for regular size of bbq chicken, then click plus button one more time', () => {
        const sql = 'select * from products where name = "Regular Chicken"'
        cy.task('queryDb', sql)
            .then((result) => {
    ...
    it('Click chicken entree, click plus button for regular size of bbq chicken, then click plus button one time, then click minus button one time', () => {
        const sql = 'select * from products where name = "Regular Chicken"'
        cy.task('queryDb', sql)
            .then((result) => {
                // 1 is serialNumber in cart
    ...
    it('Click chicken entree, click plus button for regular size of bbq chicken, then click Remove button', () => {
        const sql = 'select * from products where name = "Regular Chicken"'
        cy.task('queryDb', sql)
            .then((result) => {
                // cart count should be 1
    ...
    it('Click chicken entree, click plus button for regular size of bbq chicken, then click Edit button -- change quantity to 3, 2, then click Update button', () => {
        const sql = 'select * from products where name = "Regular Chicken"'
        cy.task('queryDb', sql)
            .then((result) => {
                // cart count should be 1
    ...
    it('Click chicken entree, click plus button for regular size of bbq chicken, then click Add More Items to same item', () => {
    ...
    it('Click chicken entree, click plus button for regular size of bbq chicken, then click Add More Items to click plus button for large size of bbq chicken', () => {
        cy.get('.addMoreItems').click()
        cy.wait(1000)
        cy.clickChickenEntree()
        cy.wait(1000)
        cy.selectChickenEntreeSize('BBQ Chicken', "Large")
        cy.clickEntreePlus('BBQ Chicken')
        cy.clickEntreeAddToCart('BBQ Chicken')
        cy.wait(1000)
        ...
        var priceRegular = 0
        var priceLarge = 0
        const sqlRegular = 'select * from products where name = "Regular Chicken"'
        ...
        const sqlLarge = 'select * from products where name = "Large Chicken"'
    ...
    it('Click chicken entree, click plus button for regular size of bbq chicken, then click Empty Cart button, cancel to empty the cart', () => {
        const sql = 'select * from products where name = "Regular Chicken"'
        cy.task('queryDb', sql)
            .then((result) => {
                // Back to cart and check all values
    ...
    it('Click chicken entree, click plus button for regular size of bbq chicken, then click Empty Cart button, ok to empty the cart', () => {
        const sql = 'select * from products where name = "Regular Chicken"'
        cy.task('queryDb', sql)
            .then((result) => {
                // Back to cart and check all values
    ...
    it('Click chicken entree, click plus button for regular size of bbq chicken, then type "Not too spicy" for note and forgot to click Update Note button, then click Checkout button', () => {
    ...
    it('Click chicken entree, click plus button for regular size of bbq chicken, then type "Not too spicy" for note and click Update Note button, then click Checkout button', () => {
        cy.get('#ordernote').type('Not too spicy')
