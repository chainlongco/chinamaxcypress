...
describe('Visit cart, add regular platter, and check in the cart', () => {
    it('Click regular platter, choose fried rice and BBQ chicken and black pepper chicken, then check all information on the screen', () => {
        cy.get('#cart_count').contains('1')

        const sql = 'select * from products where name = "Regular Platter"'
        cy.task('queryDb', sql)
            .then((result) => {
                // Image
                ...
                cy.get('#orderlist > form > div > div > div.col-md-6 > h5:nth-child(2) > small').contains('Side: Fried Rice(1) Entree: BBQ Chicken(1) Black Pepper Chicken(1)')
    ...
    it('Click regular platter, choose fried rice and BBQ chicken and black pepper chicken, then click plus button one time', () => {
        const sql = 'select * from products where name = "Regular Platter"'
        cy.task('queryDb', sql)
            .then((result) => {
    ...
    it('Click regular platter, choose fried rice and BBQ chicken and black pepper chicken, then click plus button one time, then click minus button one time', () => {
        const sql = 'select * from products where name = "Regular Platter"'
        cy.task('queryDb', sql)
            .then((result) => {
                // 1 is serialNumber in cart
    ...
    it('Click regular platter, choose fried rice and BBQ chicken and black pepper chicken, then click Remove button', () => {
        const sql = 'select * from products where name = "Regular Platter"'
        cy.task('queryDb', sql)
            .then((result) => {
                // cart count should be 1
    ...
    it('Click regular platter, choose fried rice and BBQ chicken and black pepper chicken, then click Edit button -- change quantity to 3, 2, then change to Fried Rice(half), Chow Mein(half), Black Pepper Chicken and General Taos Chicken, then click Update button', () => {
        const sql = 'select * from products where name = "Regular Platter"'
        cy.task('queryDb', sql)
            .then((result) => {
                // cart count should be 1
                ...
                cy.checkChoiceSelectedOrNoWithPlusMinusButtons('Entree', 'entrees', 'BBQ Chicken', true, 1)    
                ...
                cy.get('#orderlist > form > div > div > div.col-md-6 > h5.pt-2').contains(result[0].name)
                cy.get('#orderlist > form > div > div > div.col-md-6 > h5.pt-2').contains(result[0].description)
                cy.get('#orderlist > form > div > div > div.col-md-6 > h5:nth-child(2) > small').contains('Side: Fried Rice(1/2) Chow Mein(1/2) Entree: Black Pepper Chicken(1) General Taos Chicken(1)')
                cy.get('#orderlist > form > div > div > div.col-md-6 > h5.pt-1').contains(result[0].price)
            })
    })

    it('Click regular platter, choose fried rice and BBQ chicken and black pepper chicken, then click Add More Items to same item and subItems', () => {
    ...
    it('Click regular platter, choose fried rice and BBQ chicken and black pepper chicken, then click Add More Items to same item and but different subItems', () => {
        cy.get('.addMoreItems').click()
        cy.wait(1000)
        cy.clickRegularPlatter()
        cy.wait(1000)
        ...
        cy.task('queryDb', sql)
            .then((result) => {
                ...
                cy.get('#orderlist > form > div > div > div.col-md-6 > h5.pt-2').contains(result[0].name)
                cy.get('#orderlist > form > div > div > div.col-md-6 > h5.pt-2').contains(result[0].description)
                cy.get('#orderlist > form > div > div > div.col-md-6 > h5:nth-child(2) > small').contains('Side: Fried Rice(1) Entree: Black Pepper Chicken(1) General Taos Chicken(1)')
                cy.get('#orderlist > form > div > div > div.col-md-6 > h5.pt-1').contains(result[0].price)
            })
    })

    it('Click regular platter, choose fried rice and BBQ chicken and black pepper chicken, then click Empty Cart button, cancel to empty the cart', () => {
        const sql = 'select * from products where name = "Regular Platter"'
        cy.task('queryDb', sql)
            .then((result) => {
                // Back to cart and check all values
    ...
    it('Click regular platter, choose fried rice and BBQ chicken and black pepper chicken, then click Empty Cart button, ok to empty the cart', () => {
        const sql = 'select * from products where name = "Regular Platter"'
        cy.task('queryDb', sql)
            .then((result) => {
                // Back to cart and check all values
    ...
    it('Click regular platter, choose fried rice and BBQ chicken and black pepper chicken, then type "Not too spicy" for note and forgot to click Update Note button, then click Checkout button', () => {
    ...
    it('Click regular platter, choose fried rice and BBQ chicken and black pepper chicken, then type "Not too spicy" for note and click Update Note button, then click Checkout button', () => {
        cy.get('#ordernote').type('Not too spicy')
