...
describe('Large Platter', () => {
    it('Check add to cart button is disabled', () =>{
        cy.checkAddToCartButtonDisabled('products', 'Large Platter', 'addToCartForCombo')
    })
    ...
    it('Click side and entree to enable add to cart button', () => {
        ...
        cy.checkAddToCartButtonEnabled('products', 'Large Platter', 'addToCartForCombo')
    })

    it('Click quantityPlus and check quantity', () => {
        cy.clickPlusButtonAndCheckQuantity('products', 'Large Platter', 'quantity', 2)
    })

    it('Click quantityMinus and check quantity', () => {
        cy.clickMinusButtonAndCheckQuantity('products', 'Large Platter', 'quantity', 0)
    })
